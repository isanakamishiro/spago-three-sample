...
//go:generate spago generate -c TestView -p views testview.html
...
func NewTestView() *TestView {
	...
	renderer.JSValue().Call("setScissorTest", true)
	log.Println(renderer.JSValue().Call("getScissorTest"))
...
func (c *TestView) animate(this js.Value, args []js.Value) interface{} {
...
// OnResize ...
func (c *TestView) OnResize(this js.Value, args []js.Value) interface{} {
